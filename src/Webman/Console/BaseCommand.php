...
namespace Dsxwk\Framework\Webman\Console;
...
abstract class  BaseCommand extends Command
{
    ...
    protected function initialize(InputInterface $input, OutputInterface $output): void
    {
        ...
        // 初始化数据库
        $this->db = new Capsule();
        $this->db->addConnection(Config::get('database.connections.' . Config::get('database.default'), 'mysql'));
        $this->db->setAsGlobal();
        $this->db->bootEloquent();

        $this->log("Environment and database initialized.");
    }
